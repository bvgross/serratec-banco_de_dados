...
---------------------------------------------------------------------------------
--5
--criando uma tabela temporaria chamada consultas_dentistas que armazena o nome e o total de consultas de cada médico
...
--criando uma tabela temporaria chamada total_consultas para armazenar só o total de consultas
total_consultas AS (
...
SELECT 
    ...
    ROUND((cd.total_consultas / tc.sum_total), 2) AS "Média (consultas totais/consultas médico)" --calculo do percentual
FROM consultas_dentistas cd --a tabela temporaria com nome e o total de cada médico
CROSS JOIN total_consultas tc --a tabela que armazena só o total
